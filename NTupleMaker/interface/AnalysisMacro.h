...
int el_index=-1;
   ...
   Int_t	   electron_index_1;
   Int_t	   electron_index_2;
   Int_t	   taus_index;
   Int_t	   taus_index_1;
   Int_t	   taus_index_2;
   Int_t           mu_count;
   ...
   Float_t 	   trig_weight_1looseAC;
   Float_t 	   trig_weight_2looseAC;
   Float_t 	   trig_weight_1looseBC;
   Float_t 	   trig_weight_2looseBC;
   ...
   Float_t	   isDYMM;
   Float_t	   isDYNuNu;
   Float_t	   isFromTauTau;
   Float_t	   isFromTauMuon;
   Float_t	   isFromTauEl;
   Float_t	   isFromElEl;
   Float_t	   isFromMuonMuon;
   Float_t	   isFromOther;
...
*/
  ...
  T->Branch("LSF_weight_3", &LSF_weight_3, "LSF_weight_3/F");
  ...
  T->Branch("trig_weight_1looseAC", &trig_weight_1looseAC, "trig_weight_1looseAC/F");
  T->Branch("trig_weight_2looseAC", &trig_weight_2looseAC, "trig_weight_2looseAC/F");
  T->Branch("trig_weight_1looseBC", &trig_weight_1looseBC, "trig_weight_1looseBC/F");
  T->Branch("trig_weight_2looseBC", &trig_weight_2looseBC, "trig_weight_2looseBC/F");
  ...
  T->Branch("electron_index_1", &electron_index_1, "electron_index_1/I");
  T->Branch("electron_index_2", &electron_index_2, "electron_index_2/I");
  ...
  T->Branch("nbtagL", &nbtagL, "nbtagL/I");
  T->Branch("nbtagM", &nbtagM, "nbtagM/I");
  T->Branch("nbtagT", &nbtagT, "nbtagT/I");
  ...
  T->Branch("isFromTauTau", &isFromTauTau);
  T->Branch("isFromTauMuon", &isFromTauMuon);
  T->Branch("isFromTauEl", &isFromTauEl);
  T->Branch("isFromElEl", &isFromElEl);
  T->Branch("isFromMuonMuon", &isFromMuonMuon);
  T->Branch("isFromOther", &isFromOther);
